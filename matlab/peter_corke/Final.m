...
T_desired = transl(3, 2, 180) * R;  % Target position with desired rotation
T_desired_2 = transl(100, 2, 500) * R;  % Target position with desired rotation
T_desired_3 = transl(30, 20, 300) * R;  % Target position with desired rotation
T_desired_4 = transl(4, 100, 20) * R;  % Target position with desired rotation

% Combine all desired poses into an array for iteration
T_desired_all = {T_desired, T_desired_2, T_desired_3, T_desired_4};
...
for i = 1:length(T_desired_all)
    ...
    if isempty(q_target)
        ...
        % Create an array to store the end-effector positions for the trajectory
